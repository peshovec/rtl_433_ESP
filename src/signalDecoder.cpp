...
if (rtl_433_ESP::ookModulation) {
  ...
  memcpy(&cfg->devices[120], &schou_72543_rain, sizeof(r_device));
  memcpy(&cfg->devices[121], &schraeder, sizeof(r_device));
  memcpy(&cfg->devices[122], &schrader_EG53MA4, sizeof(r_device));
  memcpy(&cfg->devices[123], &schrader_SMD3MA4, sizeof(r_device));
  memcpy(&cfg->devices[124], &scmplus, sizeof(r_device));
  memcpy(&cfg->devices[125], &secplus_v1, sizeof(r_device));
  memcpy(&cfg->devices[126], &silvercrest, sizeof(r_device));
  memcpy(&cfg->devices[127], &ss_sensor, sizeof(r_device));
  memcpy(&cfg->devices[128], &skylink_motion, sizeof(r_device));
  ...
  memcpy(&cfg->devices[142], &tpms_eezrv, sizeof(r_device));
  memcpy(&cfg->devices[143], &tpms_tyreguard400, sizeof(r_device));
  memcpy(&cfg->devices[144], &ts_ft002, sizeof(r_device));
  memcpy(&cfg->devices[145], &ttx201, sizeof(r_device));
  memcpy(&cfg->devices[146], &vaillant_vrt340f, sizeof(r_device));
  memcpy(&cfg->devices[147], &vauno_en8822c, sizeof(r_device));
  memcpy(&cfg->devices[148], &visonic_powercode, sizeof(r_device));
  memcpy(&cfg->devices[149], &waveman, sizeof(r_device));
  memcpy(&cfg->devices[150], &wec2103, sizeof(r_device));
  memcpy(&cfg->devices[151], &wg_pb12v1, sizeof(r_device));
  memcpy(&cfg->devices[152], &ws2032, sizeof(r_device));
  memcpy(&cfg->devices[153], &wssensor, sizeof(r_device));
  memcpy(&cfg->devices[154], &wt1024, sizeof(r_device));
  memcpy(&cfg->devices[155], &wt450, sizeof(r_device));
  memcpy(&cfg->devices[156], &X10_RF, sizeof(r_device));
  memcpy(&cfg->devices[157], &x10_sec, sizeof(r_device));
  memcpy(&cfg->devices[158], &yale_hsa, sizeof(r_device));
} else {
  ...
  memcpy(&cfg->devices[7], &bresser_leakage, sizeof(r_device));
  memcpy(&cfg->devices[8], &bresser_lightning, sizeof(r_device));
  memcpy(&cfg->devices[9], &cavius, sizeof(r_device));
  memcpy(&cfg->devices[10], &ced7000, sizeof(r_device));
  memcpy(&cfg->devices[11], &current_cost, sizeof(r_device));
  memcpy(&cfg->devices[12], &danfoss_CFR, sizeof(r_device));
  memcpy(&cfg->devices[13], &directv, sizeof(r_device));
  memcpy(&cfg->devices[14], &ecodhome, sizeof(r_device));
  memcpy(&cfg->devices[15], &efergy_e2_classic, sizeof(r_device));
  memcpy(&cfg->devices[16], &efergy_optical, sizeof(r_device));
  memcpy(&cfg->devices[17], &emax, sizeof(r_device));
  memcpy(&cfg->devices[18], &emontx, sizeof(r_device));
  memcpy(&cfg->devices[19], &esic_emt7110, sizeof(r_device));
  memcpy(&cfg->devices[20], &fineoffset_WH25, sizeof(r_device));
  memcpy(&cfg->devices[21], &fineoffset_WH51, sizeof(r_device));
  memcpy(&cfg->devices[22], &tfa_303151, sizeof(r_device));
  memcpy(&cfg->devices[23], &fineoffset_wh1080_fsk, sizeof(r_device));
  memcpy(&cfg->devices[24], &fineoffset_wh31l, sizeof(r_device));
  memcpy(&cfg->devices[25], &fineoffset_wh45, sizeof(r_device));
  memcpy(&cfg->devices[26], &fineoffset_wn34, sizeof(r_device));
  memcpy(&cfg->devices[27], &fineoffset_ws80, sizeof(r_device));
  memcpy(&cfg->devices[28], &fineoffset_ws90, sizeof(r_device));
  memcpy(&cfg->devices[29], &flowis, sizeof(r_device));
  memcpy(&cfg->devices[30], &ge_coloreffects, sizeof(r_device));
  memcpy(&cfg->devices[31], &geo_minim, sizeof(r_device));
  memcpy(&cfg->devices[32], &hcs200_fsk, sizeof(r_device));
  memcpy(&cfg->devices[33], &holman_ws5029pcm, sizeof(r_device));
  memcpy(&cfg->devices[34], &holman_ws5029pwm, sizeof(r_device));
  memcpy(&cfg->devices[35], &hondaremote, sizeof(r_device));
  memcpy(&cfg->devices[36], &honeywell_cm921, sizeof(r_device));
  memcpy(&cfg->devices[37], &honeywell_wdb_fsk, sizeof(r_device));
  memcpy(&cfg->devices[38], &ikea_sparsnas, sizeof(r_device));
  memcpy(&cfg->devices[39], &inkbird_ith20r, sizeof(r_device));
  memcpy(&cfg->devices[40], &insteon, sizeof(r_device));
  memcpy(&cfg->devices[41], &lacrosse_breezepro, sizeof(r_device));
  memcpy(&cfg->devices[42], &lacrosse_r1, sizeof(r_device));
  memcpy(&cfg->devices[43], &lacrosse_th3, sizeof(r_device));
  memcpy(&cfg->devices[44], &lacrosse_tx31u, sizeof(r_device));
  memcpy(&cfg->devices[45], &lacrosse_tx34, sizeof(r_device));
  memcpy(&cfg->devices[46], &lacrosse_tx29, sizeof(r_device));
  memcpy(&cfg->devices[47], &lacrosse_tx35, sizeof(r_device));
  memcpy(&cfg->devices[48], &lacrosse_wr1, sizeof(r_device));
  memcpy(&cfg->devices[49], &m_bus_mode_c_t, sizeof(r_device));
  memcpy(&cfg->devices[50], &m_bus_mode_c_t_downlink, sizeof(r_device));
  memcpy(&cfg->devices[51], &m_bus_mode_s, sizeof(r_device));
  memcpy(&cfg->devices[52], &m_bus_mode_r, sizeof(r_device));
  memcpy(&cfg->devices[53], &m_bus_mode_f, sizeof(r_device));
  memcpy(&cfg->devices[54], &marlec_solar, sizeof(r_device));
  memcpy(&cfg->devices[55], &maverick_xr30, sizeof(r_device));
  memcpy(&cfg->devices[56], &oil_smart, sizeof(r_device));
  memcpy(&cfg->devices[57], &oil_standard, sizeof(r_device));
  memcpy(&cfg->devices[58], &oil_watchman, sizeof(r_device));
  memcpy(&cfg->devices[59], &oil_watchman_advanced, sizeof(r_device));
  memcpy(&cfg->devices[60], &rojaflex, sizeof(r_device));
  memcpy(&cfg->devices[61], &sharp_spc775, sizeof(r_device));
  memcpy(&cfg->devices[62], &simplisafe_gen3, sizeof(r_device));
  memcpy(&cfg->devices[63], &somfy_iohc, sizeof(r_device));
  memcpy(&cfg->devices[64], &srsmith_pool_srs_2c_tx, sizeof(r_device));
  memcpy(&cfg->devices[65], &steelmate, sizeof(r_device));
  memcpy(&cfg->devices[66], &tfa_14_1504_v2, sizeof(r_device));
  memcpy(&cfg->devices[67], &tfa_303196, sizeof(r_device));
  memcpy(&cfg->devices[68], &tfa_marbella, sizeof(r_device));
  memcpy(&cfg->devices[69], &tpms_abarth124, sizeof(r_device));
  memcpy(&cfg->devices[70], &tpms_ave, sizeof(r_device));
  memcpy(&cfg->devices[71], &tpms_citroen, sizeof(r_device));
  memcpy(&cfg->devices[72], &tpms_elantra2012, sizeof(r_device));
  memcpy(&cfg->devices[73], &tpms_ford, sizeof(r_device));
  memcpy(&cfg->devices[74], &tpms_hyundai_vdo, sizeof(r_device));
  memcpy(&cfg->devices[75], &tpms_jansite, sizeof(r_device));
  memcpy(&cfg->devices[76], &tpms_jansite_solar, sizeof(r_device));
  memcpy(&cfg->devices[77], &tpms_kia, sizeof(r_device));
  memcpy(&cfg->devices[78], &tpms_nissan, sizeof(r_device));
  memcpy(&cfg->devices[79], &tpms_pmv107j, sizeof(r_device));
  memcpy(&cfg->devices[80], &tpms_porsche, sizeof(r_device));
  memcpy(&cfg->devices[81], &tpms_renault, sizeof(r_device));
  memcpy(&cfg->devices[82], &tpms_renault_0435r, sizeof(r_device));
  memcpy(&cfg->devices[83], &tpms_toyota, sizeof(r_device));
  memcpy(&cfg->devices[84], &tpms_truck, sizeof(r_device));
}
...
#  endif
    ...
    if (events == 0) {
      ...
      pulse_analyzer(rtl_pulses, rtl_433_ESP::ookModulation ? 1 : 2, &device);
#endif
